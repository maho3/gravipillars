...
toggField=3;                %gravity=0, ideal spring=1, real spring=2, bimodal spring=3
magO=10000;                %set strength (G*mass) of gravity field
a=6;                        %set origin planet width
...
frictionRadius=2*a;         %set radius of friction field
...
magP=1000;                   %set magnitude of particle field
pA=3;                       %set radius of particle "planets"
...
g(1)=plot3(o(1),o(2),o(3),'k+');    %plot initial origin
grid on
xlabel('x')
ylabel('y')
zlabel('z')
...
for k = 1:T
    ...
    if toggMoveOrigin==1
        ...
        g(k+1)=plot3(o(1),o(2),o(3),'k+');  %plot origin
        delete(g(k));
